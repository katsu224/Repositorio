...
document.getElementById("tipo_informe").addEventListener("change", function () {
    ...
    // que se vea los campos de carrera y modulo sin importar el tipo de informe
        cajaCarrera.classList.remove("hidden");
        cajaModulo.classList.remove("hidden");
        /*
    // Ocultar o mostrar los campos según el tipo de informe seleccionado por id en la bd
    if (tipoInfo === "1") {
        cajaCarrera.classList.remove("hidden");
        cajaModulo.classList.remove("hidden");
...
document.getElementById("carrera").addEventListener("change", function () {
    ...
    modulo.selectedIndex = 0;
    // Habilitar el campo de módulo
       ivOption.classList.add("hidden");
        modulo.disabled = false;
    /*
    // Si la carrera es "IV", habilitar el campo de módulo
