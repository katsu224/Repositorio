        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/informes/add"
                        class="ms-1 text-sm font-medium text-gray-600 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Añadir
                        Proyecto</a>
                </div>
            </li>
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Proyectos</span>
                </div>
            </li>
        </ol>
    </nav>

    <h2 class="mb-6 text-3xl font-bold text-center text-gray-900 dark:text-white">GESTIONAR PROYECTOS</h2>
        ...
        <table class="min-w-full bg-white rounded-lg shadow-md">
            <thead class="bg-gray-800 text-white">
                <tr>
                    ...
                    <th class="py-3 px-5">TÍTULO</th>
                    <th class="py-3 px-5">AÑO</th>
                    <th class="py-3 px-5">TIPO</th>
                    <th class="py-3 px-5">AUTORES</th>
                ...
                @else
                    @foreach ($informes as $info)
                        <tr class="hover:bg-gray-100 transition duration-200 border-b">
                            <td class="p-3 text-center text-sm">{{ $info->id }}</td>
                            <td class="p-3 text-center">{{ $info->titulo }}</td>
                            <td class="p-3 text-center text-sm">{{ $info->anio }}</td>
                            ...
                            <td class="p-3 flex justify-center gap-1">
                                ...
                                <a href="javascript:void(0);" data-tw-toggle="modal"
                                    data-tw-target="#delete-modal{{ $info->id }}" type="button"
