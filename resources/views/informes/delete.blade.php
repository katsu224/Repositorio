                ...
                <div
                    ...
                    <div class="bg-white dark:bg-zinc-700 p-2">
                        ...
                        <div class="p-4 text-center">
                            ...
                            <h5 class="mt-4 text-gray-600 dark:text-gray-100" style="font-size: 1rem">Estás seguro de
                                que deseas eliminar el Proyecto : <b>{{ $info->id }}</b>?</h5>
                        </div>
