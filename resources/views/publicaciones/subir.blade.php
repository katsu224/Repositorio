@foreach ($publicaciones as $info)
    <div class="relative z-50 hidden modal" id="publicar-modal{{ $info->id }}" aria-labelledby="modal-title"
            ...
            <div class="p-4 mx-auto text-center animate-translate sm:max-w-lg">
                <div
                    ...
                    <div class="p-5 text-center bg-white dark:bg-zinc-700">
                        ...
                        <h2 class="mt-5 text-xl font-semibold text-gray-700 dark:text-gray-100">Confirmar Publicación</h2>
                        <p class="mt-2 text-gray-500 dark:text-zinc-100/60" style="font-size: 1rem">Estas seguro que
                           ...
                           <form action="/informes/publicar/{{ $info->id }} " method="POST">
                                @csrf
                                @method('PUT')
