@foreach ($autores as $autor)
    <div class="relative z-50 hidden modal" id="edit-modal{{ $autor->dni }}" aria-labelledby="modal-title" role="dialog"
        aria-modal="true">
                ...
                <div
                    ...
                    <div class="bg-white dark:bg-zinc-800">
                        ...
                        <div class="p-4 text-center border-b border-gray-300">
                            <h3 class="mt-4 text-2xl font-semibold text-gray-800 dark:text-gray-200">EDITAR DATOS:
                                {{ $autor->dni }}</h3>
                        </div>
                                ...
                                <div class="grid gap-4">
                                    <div class="w-full">
                                        <label for="dni"
                                            ...
                                            Documento (DNI) *</label>
                                        <input type="text" name="dni" id="dni" value="{{ $autor->dni }}"
